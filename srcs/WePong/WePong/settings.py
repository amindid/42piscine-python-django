"""
Django settings for WePong project.
...
SECRET_KEY = 'django-insecure-to&=t8)7^(uy7n0kz%8m=&_q4@@t8ttr_mja1tbqogwoj(gwt@'
...
WSGI_APPLICATION = 'WePong.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'WePongAuth/static'),
]
